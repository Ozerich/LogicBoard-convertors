...
=====================================================
*/
$config = array('smiles' => "wink,winked,smile,am,belay,feel,fellow,laughing,lol,love,no,recourse,request,sad,tongue,wassat,crying,what,bully,angry");
...
class ParseFilter {
	...
	function decodeBBCodes($txt, $use_html = TRUE, $wysiwig = "no") {
        ...
        $txt = preg_replace( "#<!--dle_spoiler-->.+?<!--spoiler_title-->(.+?)<!--spoiler_title_end-->.+?<!--spoiler_text-->#is", '[spoiler=\\1]', $txt );
        ...
        global $config;
		$smilies_arr = explode( ",", $config['smiles']);
