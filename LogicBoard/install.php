...
function InstallLB($host, $login, $password, $db_name, $table_prefix)
{
	...
	$table_name = $table_prefix."forums";
...
$table_name = $table_prefix."members";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  ...
  `view_topic` text NOT NULL default '',
...
$table_name = $table_prefix."members_banfilters";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
...
$table_name = $table_prefix."topics";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
...
$table_name = $table_prefix."topics_poll";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
...
$table_name = $table_prefix."topics_poll_logs";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `poll_id` int(10) NOT NULL DEFAULT '0',
...
$table_name = $table_prefix."forums_moderator";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
...
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  ...
  `g_link_signature` tinyint(1) NOT NULL default '1',
...
$table_name = $table_prefix."members_ranks";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  `id` mediumint(8) NOT NULL AUTO_INCREMENT,
  `title` varchar(255)  NOT NULL DEFAULT '',
...
$table_name = $table_prefix."topics_subscribe";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
...
$table_name = $table_prefix."members_reputation";
@mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `from_id` mediumint(8) NOT NULL DEFAULT '0',
  `from_name` varchar(40) NOT NULL DEFAULT '',
  `to_id` mediumint(8) NOT NULL DEFAULT '0',
  `to_name` varchar(40) NOT NULL DEFAULT '',
  `date` int(10) NOT NULL DEFAULT '0',
...
$table_name = $table_prefix."topics_files";
mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
...
$table_name = $table_prefix."members_warning";
mysql_query("DROP TABLE $table_name", $handle);
mysql_query("CREATE TABLE IF NOT EXISTS `$table_name` (
 `id` mediumint(8) NOT NULL auto_increment,
